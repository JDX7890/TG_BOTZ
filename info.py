...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5892507422 5165943027').split()]
...
SHORTLINK_API = environ.get('SHORTLINK_API', '4a1db8b9c039822da4b607875eec37d838e17e96')
